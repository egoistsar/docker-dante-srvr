...
DEPS=(curl git docker.io sudo iptables systemd systemd-sysv net-tools apparmor-utils)
...
docker build --no-cache --security-opt apparmor=unconfined -t dante-proxy-auto . >"$DOCKER_BUILD_LOG" 2>&1 || BUILD_FAILED=1
